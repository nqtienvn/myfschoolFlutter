...
export default function ActivationPage({ academicYearId, academicYearStatus, onChanged, onNavigate }: Props) {
  ...
  return (
    <div className="page-stack">
      <section className="page-heading"><div><span className="eyebrow">Bước 8</span><h1>Kích hoạt năm học</h1><p>Đây là bước cuối cùng của quy trình thiết lập.</p></div></section>
