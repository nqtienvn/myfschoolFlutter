...
export default function TimetablesPage({ selectedYearId, selectedSemesterId }: { selectedYearId?: string; selectedSemesterId?: string }) {
  ...
  return <div className="page-stack">
    <div className="page-heading"><div><span className="eyebrow">Bước 7</span><h1>Thời khóa biểu</h1><p>Tạo phiên bản nháp, kiểm tra và phát hành theo ngày hiệu lực trong học kỳ.</p></div></div>
