...
export default function TeacherGradesPage() {
  ...
  return <main className="teacher-page page-stack">
    <div className="page-heading"><div><p className="teacher-eyebrow">Lớp giảng dạy</p><h1>Nhập điểm</h1><p>Nhập trực tiếp trên lưới hoặc upload Excel/CSV; Admin công bố điểm linh hoạt theo từng đầu điểm.</p></div></div>
