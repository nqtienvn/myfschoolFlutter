...
export default function TeacherPeriodicReviewsPage() {
  ...
  return <main className="teacher-page page-stack">
    <div className="page-heading"><div><p className="teacher-eyebrow">Đánh giá học sinh</p><h1>Nhận xét định kỳ</h1><p>GVBM và GVCN Submit độc lập; GVCN không duyệt nhận xét môn và không chọn hạnh kiểm.</p></div></div>
