...
```text
Giáo viên soạn theo lớp → Admin duyệt/từ chối
→ nếu duyệt, backend tạo snapshot người nhận → PH/HS đọc thông báo
...
- Thông báo giáo viên luôn bắt đầu ở trạng thái `PENDING`.
...
```text
POST /api/announcements                         # Giáo viên gửi duyệt
PUT  /api/announcements/{id}/review             # Admin duyệt/từ chối
...
- Thông báo giáo viên chưa duyệt không sinh snapshot người nhận.
- Duyệt thông báo mới tạo snapshot và phát hành.
